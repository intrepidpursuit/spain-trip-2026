# One-off patch: add La Musclera as the Sep 24 backup.
# Runs as the Netlify build step. Idempotent, and never fails the build:
# if an anchor is missing it skips that edit.
